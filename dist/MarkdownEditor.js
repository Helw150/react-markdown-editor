...
var MarkdownEditor = React.createClass({displayName: "MarkdownEditor",
  ...
  render: function() {
    ...
    if (this.state.inEditMode) {
      divContent = React.createElement(MarkdownEditorContent, {styles: {styleMarkdownTextArea: this.props.styles.styleMarkdownTextArea}, 
							       content: this.state.content, onChangeHandler: this.onChangeHandler});
	if(this.props.editorTabs != false){
      editorMenu = React.createElement(MarkdownEditorMenu, {styles: {styleMarkdownMenu: this.props.styles.styleMarkdownMenu}, 
							    iconsSet: this.props.iconsSet});
	}
    } else {
      divContent = React.createElement(MarkdownEditorPreview, {styles: {styleMarkdownPreviewArea: this.props.styles.styleMarkdownPreviewArea}, 
    ...
    return (
      React.createElement("div", {style: styleMarkdownEditorContainer}, 
        React.createElement("div", {style: styleMarkdownEditorHeader, className: "md-editor-header"}, 
          editorMenu, 
          React.createElement(MarkdownEditorTabs, {styles: { styleMarkdownEditorTabs: this.props.styles.styleMarkdownEditorTabs, 
